...
public class FeedDB extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String createTable =
				"CREATE TABLE IF NOT EXISTS " + this.DATABASE_NAME + "." + this.TABLE_NAME + "("
				+ this.FIELD_ID + " INTEGER PRIMARY KEY,"
				+ this.FIELD_TITLE + " TEXT,"
				+ this.FIELD_LINK + " TEXT,"
				+ this.FIELD_CATEGORY + " TEXT,"
				+ this.FIELD_DESCRIPTION + " TEXT,"
				+ this.FIELD_DATE + " TEXT,"
				+ this.FIELD_SOURCE + " TEXT,"
				+ ")";
	...
	public int getFeedCount() {
		String countQuery = "SELECT  * FROM " + this.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public int updateFeed(com.corelib.FeedItem feedItem) {
		...
		// updating row
		return db.update(this.TABLE_NAME, contentValues, this.FIELD_ID + " = ?",
	...
	public void deleteFeed(int id) {
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(this.TABLE_NAME, this.FIELD_ID + " = ?",
	...
	private ContentValues populate(com.corelib.FeedItem feedItem) {
		...
		contentValues.put(this.FIELD_TITLE, feedItem.getTitle());
		contentValues.put(this.FIELD_LINK, feedItem.getLink());
		contentValues.put(this.FIELD_CATEGORY, feedItem.getCategory());
		contentValues.put(this.FIELD_DESCRIPTION, feedItem.getDescription());
		contentValues.put(this.FIELD_DATE, feedItem.getDate());
		contentValues.put(this.FIELD_SOURCE, feedItem.getSource());
